...
export class HttpserviceService {
  ...
  getCurrentUser() : Observable<any>{
    return this.http.get('https://adventours--app.herokuapp.com/api/v1/users/me',{withCredentials:true})
  }
  ...
  updateUser(data): Observable<any>{
    console.log(data)
    return this.http.patch('https://adventours--app.herokuapp.com/api/v1/users/updateMe',data,{withCredentials:true})
  }
  updatePassword(data): Observable<any>{
    console.log(data);
    return this.http.patch('https://adventours--app.herokuapp.com/api/v1/users/updateMyPassword',data,{withCredentials:true})
  }
